...
var oneMinuteSignupMessageType={ResetRequestScript:"ResetRequestScript",ResetScript:"ResetScript",LogoutScript:"LogoutScript",UserInformationNeeded:"UserInformationNeeded",NavigateToTab:"NavigateToTab",SaveDiscoveredApps:"SaveDiscoveredApps",Done:"Done",Error:"Error",Log:"Log",SavedToVault:"SavedToVault",GetToken:"GetToken",LaunchApplication:"LaunchApplication",CloseTab:"CloseTab",GetOauthToken:"getOauthToken",ReceivedOauthToken:"token"};window.addEventListener("message",function(e){e.origin===window.location.origin&&function(e){return Object.values(oneMinuteSignupMessageType).indexOf(e)>=0}(message.data.type)&&!message.data.fromExtension&&self.port.emit("message",e.data)},!1),window.onload=function(){document.body.setAttribute("lastpass-extension-id",self.id||"0"),document.body.setAttribute("lastpass-extension-version",self.version||"0")},self.port.on("message",function(e){e.fromExtension=!0,window.postMessage(e,"https://1min-ui-prod.service.lastpass.com")});
