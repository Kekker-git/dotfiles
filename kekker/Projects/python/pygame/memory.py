...
def main():
    ...
    while True:
        ...
        DISPLAYSURF.fill(BGCOLOR) # draws the window
        ...
        if boxx != None and boxy != None:
            ...
            if not revealedBoxes[boxx][boxy] and mouseClicked:
                ...
                if firstSelection == None: # if the current box was the firstSelection
                    firstSelection = (boxx, boxy)
                else: # the box was the second of the two
                    icon1shape, icon1color = \
                      getShapeAndColor(mainBoard, \
                      firstSelection[0], firstSelection[1])
                    icon2shape, icon2color = \
                      getShapeAndColor(mainBoard, boxx, boxy)

                    if icon1shape != icon2shape or icon1color != icon2color: # icons don't match
                    ...
                    elif hasWon(revealedBoxes): # check it all pairs were found
                    ...
                    firstSelection = None # reset the first selection
...
def leftTopCoordsOfBox(boxx, boxy):
    # convert board coords into pixels
...
def getShapeAndColor(board, boxx, boxy):
    ...
    # color value is in board[x][y][1]
    return board[boxx][boxy][0], board[boxx][boxy][1]

def drawBoxCovers(board, boxes, coverage):
    # draws boxes being covered/revealed. "boxes" is a list of
